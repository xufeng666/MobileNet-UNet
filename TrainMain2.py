...
from GAMModel2 import Mobilev2_GAM_UNET
...
# parallel_model.fit(x_train, y_train, epochs=200, batch_size=6,verbose=1, callbacks=[Tensorboard])



model.compile(optimizer ='adam', loss = 'binary_crossentropy', metrics = ['accuracy'])
Tensorboard= TensorBoard(log_dir="model2", histogram_freq=1,write_grads=True)
...
tf.keras.models.save_model(model, 'content3/dental_xray_seg_300_2.h5')